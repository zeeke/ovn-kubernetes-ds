...
func (c *SyncMap) UnlockKey(lockedKey string) {
...
func (c *SyncMap) loadOrStoreKeyLock(lockedKey string, value *keyLock) (*keyLock, bool) {
	c.keyLocksMutex.Lock()
	defer c.keyLocksMutex.Unlock()
...
func (c *SyncMap) LockKey(key string) {
...
func (c *SyncMap) Load(lockedKey string) (value string, loaded bool) {
	c.entriesMutex.Lock()
...
func (c *SyncMap) LoadOrStore(lockedKey string, newEntry string) (value string, loaded bool) {
	c.entriesMutex.Lock()
	defer c.entriesMutex.Unlock()
...
func (c *SyncMap) Store(lockedKey string, newEntry string) {
	c.entriesMutex.Lock()
	defer c.entriesMutex.Unlock()
...
func (c *SyncMap) Delete(lockedKey string) {
	c.entriesMutex.Lock()
	defer c.entriesMutex.Unlock()
...
func (c *SyncMap) DoWithLock(key string, f func(key string) error) error {
	c.LockKey(key)
